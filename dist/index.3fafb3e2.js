...
_parcelHelpers.export(exports, "grid", function () {
  return _libCanvas.grid;
});
_parcelHelpers.export(exports, "canvas", function () {
  return _libCanvas.canvas;
});
_parcelHelpers.export(exports, "startColorPicker", function () {
  return _libControls.startColorPicker;
});
_parcelHelpers.export(exports, "stopColorPicker", function () {
  return _libControls.stopColorPicker;
});
_parcelHelpers.export(exports, "pathColorPicker", function () {
  return _libControls.pathColorPicker;
});
_parcelHelpers.export(exports, "emptyColorPicker", function () {
  return _libControls.emptyColorPicker;
});
_parcelHelpers.export(exports, "obstacleColorPicker", function () {
  return _libControls.obstacleColorPicker;
});
require("jquery");
require("bootstrap");
var _libControls = require("./lib/controls");
var _libCanvas = require("./lib/canvas");
_libCanvas.grid.init();
console.log(_libCanvas.canvas);

},{"jquery":"6Oaih","bootstrap":"2wmtg","./lib/controls":"4xS7B","./lib/canvas":"12b7a","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"6Oaih":[function(require,module,exports) {
var define;
/*!
...
},{}],"2wmtg":[function(require,module,exports) {
var define;
/*!
...
},{}],"4xS7B":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "colorInputData", function () {
  return colorInputData;
});
_parcelHelpers.export(exports, "stopColorPicker", function () {
  return stopColorPicker;
});
_parcelHelpers.export(exports, "pathColorPicker", function () {
  return pathColorPicker;
});
_parcelHelpers.export(exports, "startColorPicker", function () {
  return startColorPicker;
});
_parcelHelpers.export(exports, "emptyColorPicker", function () {
  return emptyColorPicker;
});
_parcelHelpers.export(exports, "obstacleColorPicker", function () {
  return obstacleColorPicker;
});
...
var createColorPicker = _color.buildCreateColorPicker(colorInputData);
var stopColorPicker = createColorPicker("stopColor");
var pathColorPicker = createColorPicker("pathColor");
var startColorPicker = createColorPicker("startColor");
var emptyColorPicker = createColorPicker("emptyColor");
var obstacleColorPicker = createColorPicker("obstacleColor");

},{"./color":"2bKXK","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"2bKXK":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "buildCreateColorPicker", function () {
  return buildCreateColorPicker;
});
var _simonwepPickr = require("@simonwep/pickr");
var _simonwepPickrDefault = _parcelHelpers.interopDefault(_simonwepPickr);
function buildCreateColorPicker(colorInputData) {
  return function (id) {
    var colorPicker = _createColorPicker("#" + id, colorInputData[id]);
...
function _createColorPicker(id, defaultColor) {
  var colorPicker = _simonwepPickrDefault.default.create({
    el: id,
    theme: "nano",
...
},{"@simonwep/pickr":"6W97F","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"6W97F":[function(require,module,exports) {
var define;
...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    function i(t, e, o, n, i = {}) {
      ...
      for (const r of e) for (const e of o) r[t](e, n, {
        capture: !1,
        ...i
      });
    ...
    function l(t) {
      const e = (t, e) => {
        ...
        const i = e(t, ":obj"), r = e(t, ":ref"), s = i ? n[i] = {} : n;
        r && (n[r] = t);
        for (const n of Array.from(t.children)) {
          const t = e(n, ":arr"), i = o(n, t ? {} : s);
    ...
    function v(t, e, o) {
      (e /= 100, o /= 100);
      const n = f(t = t / 360 * 6), i = t - n, r = o * (1 - e), s = o * (1 - i * e), a = o * (1 - (1 - i) * e), l = n % 6;
    ...
    function y(t, e, o) {
      const n = h(t /= 255, e /= 255, o /= 255), i = d(t, e, o), r = i - n;
      let s, a;
      if (0 === r) s = a = 0; else {
        a = r / i;
        const n = ((i - t) / 6 + r / 2) / r, l = ((i - e) / 6 + r / 2) / r, c = ((i - o) / 6 + r / 2) / r;
      ...
      const i = (t, e) => (o = -1) => e(~o ? t.map(t => Number(t.toFixed(o))) : t), r = {
        ...
        toCMYK() {
          const t = (function (t, e, o) {
            const n = v(t, e, o), i = n[0] / 255, r = n[1] / 255, s = n[2] / 255, a = h(1 - i, 1 - r, 1 - s);
        ...
        toHEXA() {
          ...
          })(r.h, r.s, r.v), e = r.a >= 1 ? "" : Number((255 * r.a).toFixed(0)).toString(16).toUpperCase().padStart(2, "0");
      ...
      const e = {
        ...
        _keyboard(t) {
          ...
          if (document.activeElement === o.wrapper) {
            const {lock: o} = e.options, r = "ArrowUp" === i, s = "ArrowRight" === i, a = "ArrowDown" === i, l = "ArrowLeft" === i;
        ...
        _tapmove(t) {
          const {options: o, cache: n} = e, {lock: i, element: r, wrapper: s} = o, a = s.getBoundingClientRect();
          let l = 0, c = 0;
          if (t) {
          ...
          const p = k(l / a.width), u = k(c / a.height);
          switch (i) {
            case "v":
              return o.onchange(p);
            case "h":
    ...
    const O = {
      ...
      return {
        update(t = n) {
          ...
          return ((t, e, o) => {
            const {container: n, margin: i, position: r, variantFlipOrder: s, positionFlipOrder: a} = {
            ...
            }, [f, m = "middle"] = r.split("-"), v = a[f], b = s[m], {top: y, left: g, bottom: _, right: w} = n;
            for (const t of v) {
              const o = "t" === t || "b" === t, n = h[t], [i, r] = o ? ["top", "left"] : ["left", "top"], [s, a] = o ? [u.height, u.width] : [u.width, u.height], [l, c] = o ? [_, w] : [w, _], [p, f] = o ? [y, g] : [g, y];
              if (!(n < p || n + s > l)) for (const s of b) {
                const l = d[(o ? "v" : "h") + s];
    ...
    class x {
      ...
      _buildComponents() {
        const t = this, e = this.options.components, o = (t.options.sliders || "v").repeat(2), [n, i] = o.match(/^[vh]+$/g) ? o : [], r = () => this._color || (this._color = this._lastColor.clone()), s = {
          palette: $({
            ...
            onchange(o, n) {
              if (!e.palette) return;
              const i = r(), {_root: s, options: a} = t, {lastColor: l, currentColor: c} = s.preview;
      ...
      _bindEvents() {
        const {_root: t, options: e} = this, o = [r(t.interaction.clear, "click", () => this._clearColor()), r([t.interaction.cancel, t.preview.lastColor], "click", () => {
      ...
      _parseLocalColor(t) {
        const {values: e, type: o, a: n} = A(t), {lockOpacity: i} = this.options, r = void 0 !== n && 1 !== n;
      ...
      addSwatch(t) {
        ...
        if (e) {
          const {_swatchColors: t, _root: o} = this, n = C(...e), i = a(`<button type="button" style="--pcr-color: ${n.toRGBA().toString(0)}" aria-label="${this._t("btn:swatch")}"/>`);
    ...
    (L(x, "utils", n), L(x, "version", "1.8.1"), L(x, "I18N_DEFAULTS", {
...
},{}],"12b7a":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "grid", function () {
  return grid;
...
var grid = _grid.createGrid({
  context: _canvas.context,
  gridWidth: _canvas.canvas.width,
  gridHeight: _canvas.canvas.height,
  gridXPadding: 30,
  gridYPadding: 30,
  gridXCellSpace: 12,
  gridYCellSpace: 12,
...
},{"./grid":"18gTC","./canvas":"3VSzi","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"18gTC":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "createGrid", function () {
  return createGrid;
});
var createGrid = function createGrid(_ref) {
  var context = _ref.context, gridWidth = _ref.gridWidth, gridHeight = _ref.gridHeight, gridXPadding = _ref.gridXPadding, gridYPadding = _ref.gridYPadding, gridXCellSpace = _ref.gridXCellSpace, gridYCellSpace = _ref.gridYCellSpace, gridXCellCount = _ref.gridXCellCount, gridYCellCount = _ref.gridYCellCount;
  context.lineJoin = "round";
  context.globalCompositeOperation = "lighter";
  var gridXCellSize = calculateCellSize({
    size: gridWidth,
    count: gridXCellCount,
    space: gridXCellSpace,
    padding: gridXPadding
  });
  var gridYCellSize = calculateCellSize({
    size: gridHeight,
...
var drawGrid = function drawGrid(_ref2) {
  var context = _ref2.context, gridXPadding = _ref2.gridXPadding, gridYPadding = _ref2.gridYPadding, gridYCellSize = _ref2.gridYCellSize, gridXCellSize = _ref2.gridXCellSize, gridXCellCount = _ref2.gridXCellCount, gridYCellCount = _ref2.gridYCellCount, gridXCellSpace = _ref2.gridXCellSpace, gridYCellSpace = _ref2.gridYCellSpace;
...
var calculateCellSize = function calculateCellSize(_ref3) {
  var padding = _ref3.padding, count = _ref3.count, space = _ref3.space, size = _ref3.size;
  return (size - 2 * padding - (count - 1) * space) / count;
};
var calculateCellStart = function calculateCellStart(_ref4) {
  var padding = _ref4.padding, index = _ref4.index, space = _ref4.space, size = _ref4.size;
  return padding + index * (space + size);
};
var drawRectangle = function drawRectangle(_ref5) {
  var context = _ref5.context, startX = _ref5.startX, startY = _ref5.startY, width = _ref5.width, height = _ref5.height, border = _ref5.border;
  context.beginPath();
  context.moveTo(startX + border, startY);
  context.lineTo(startX + width - border, startY);
  context.quadraticCurveTo(startX + width - border, startY, startX + width, startY + border);
  context.lineTo(startX + width, startY + height - border);
  context.quadraticCurveTo(startX + width, startY + height - border, startX + width - border, startY + height);
  context.lineTo(startX + border, startY + height);
  context.quadraticCurveTo(startX + border, startY + height, startX, startY + height - border);
  context.lineTo(startX, startY + border);
  context.quadraticCurveTo(startX, startY + border, startX + border, startY);
  context.closePath();
  context.stroke();
};
var drawNeonRect = function drawNeonRect(_ref6) {
  var context = _ref6.context, startX = _ref6.startX, startY = _ref6.startY, width = _ref6.width, height = _ref6.height, color = _ref6.color, blur = _ref6.blur;
  var border = 1.5;
  var strokeColor = "rgba(" + color[0] + "," + color[1] + "," + color[2] + ", 1.0)";
  var shadowColor = "rgba(" + color[0] + "," + color[1] + "," + color[2] + ", 0.2 )";
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"3VSzi":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "canvas", function () {
  return canvas;
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}]},["3Imd1","5rkFb"], "5rkFb", "parcelRequire6537")
